"""Advanced Flask-Smorest CRUD Example.
...
from flask_smorest_crud import CRUDBlueprint, EnhancedBlueprint
...
def create_tables():
    ...
    if Category.query.count() == 0:
        ...
        products = [
            Product(name='Laptop', description='High-performance laptop', price=999.99, stock_quantity=50, category_id=1),
            Product(name='Smartphone', description='Latest smartphone model', price=699.99, stock_quantity=100, category_id=1),
            Product(name='Python Programming Book', description='Learn Python programming', price=49.99, stock_quantity=25, category_id=2),
            Product(name='T-Shirt', description='Comfortable cotton t-shirt', price=19.99, stock_quantity=200, category_id=3),
        ]
...
if __name__ == '__main__':
    print("Starting Advanced Flask-Smorest CRUD Example...")
