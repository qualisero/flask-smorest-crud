"""Basic Flask-More-Smorest Example.

This example demonstrates how to create a simple CRUD API using Flask-More-Smorest
...
users_blp = CRUDBlueprint("users", __name__, model="User", schema="UserSchema", url_prefix="/api/users/")
...
def create_tables():
    ...
    if User.query.count() == 0:
        sample_users = [
            User(username="alice", email="alice@example.com", first_name="Alice", last_name="Smith", age=28),
            User(username="bob", email="bob@example.com", first_name="Bob", last_name="Johnson", age=35),
            User(username="charlie", email="charlie@example.com", first_name="Charlie", last_name="Brown", age=42),
        ]
...
if __name__ == "__main__":
    print("Starting Flask-More-Smorest Example...")
